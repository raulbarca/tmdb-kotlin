...
import com.barca.tmdb.core.functional.Either.Left
...
interface MoviesRepository {
    fun upcomingMovies(page: Int = 1): Either<Failure, List<Movie>>
    ...
    @Inject constructor(private val networkHandler: NetworkHandler,
        ...
        override fun upcomingMovies(page: Int): Either<Failure, List<Movie>> {
            return when (networkHandler.isConnected) {
                true -> request(service.upcomingMovies(page = page), { it.map { it.toMovie() } }, emptyList())
