...
import com.barca.tmdb.features.movies.GetMovieDetails.Params
...
@Inject constructor(private val getMovieDetails: GetMovieDetails) : BaseViewModel() {
    ...
    private fun handleMovieDetails(movie: MovieDetails) {
        this.movieDetails.value = MovieDetailsView(movie.id, movie.title, movie.poster_path,
                movie.overview, movie.status, movie.tagline, movie.runtime, movie.homepage)
    }
}